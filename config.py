...
ASSET_CLASSES = {
  ...
  "crypto": {
    ...
    "universe": {
      ...
      "Immutable":     ("IMX-USD",   "Gaming",   "crypto"),
      "Injective":     ("INJ-USD",   "DeFi",     "crypto"),
      "The Graph":     ("GRT-USD",   "Infra",    "crypto"),
      "Aave":          ("AAVE-USD",  "DeFi",     "crypto"),
      "Maker":         ("MKR-USD",   "DeFi",     "crypto"),
      "Render":        ("RNDR-USD",  "AI/DePIN", "crypto"),
